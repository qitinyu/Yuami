...
author: "QTY"
image: "./cover1.png"
sourceLink: "https://yqamm.cc.cd/posts/20260129jc/"
date: 2026-01-11
pubDate: 2026-01-11
---
---
...
> 我们在更新项目时可能出错导致后期版本出现各种bug，这时我们需要回到之前正常的版本，这时就可以使用 中的 "检出提交"-Checkout Commit（以GitHub Desktop为例） ，它可以帮助我们回到之前正常的版本，下载之前的版本代码，再加以修改、调试，是一个非常实用的版本控制工具。因为实在难搞，所以单写一篇文章。
### 2. 检出提交的作用？
1. 时光机功能
- 查看项目在历史某一时刻的状态
- 可以查看、编辑、运行旧版本的代码
